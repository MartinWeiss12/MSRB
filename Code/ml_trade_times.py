...
cleanedValues.insert(28, 'MAT DENOM', MAT_DENOM)
...
for minutesElapsedCount in np.arange(0.1, 2.6, 0.1):
    ...
    cleanedValues.insert(19, 'CALL_FREQ_CODE', CALL_FREQ_CODE)
    cleanedValues.insert(20, 'CALL_TYPE', CALL_TYPE)
    cleanedValues.insert(21, 'OFF_WI_IND', OFF_WI_IND)
    cleanedValues.insert(22, 'OFF_SECURITY_TYPE', OFF_SECURITY_TYPE)
    cleanedValues.insert(23, 'IND_INT_TYPE', IND_INT_TYPE)
    cleanedValues.insert(24, 'DEFAULT_IND', DEFAULT_IND)
    cleanedValues.insert(25, 'COMPLETE_CALL_IND', COMPLETE_CALL_IND)
    cleanedValues.insert(26, 'PUT_EXISTS_IND', PUT_EXISTS_IND)
    cleanedValues.insert(27, 'CSB_ISSUE_TRANS', CSB_ISSUE_TRANS)
    cleanedValues.insert(28, 'ISSUE_STATUS', ISSUE_STATUS)
    cleanedValues.insert(29, 'REVENUE_TYPE', REVENUE_TYPE)
