...
pathOne = r'C:\Users\mweiss\Python Projects\ML Trade Times\CLEANED_trade_data_A.xlsx'
dataOne = pd.read_excel(pathOne, sheet_name = 'trade_report_time_elapsed_data')
pathTwo = r'C:\Users\mweiss\Python Projects\ML Trade Times\CLEANED_trade_data_B.xlsx'
...
for minutesElapsedCount in np.arange(0.1, 2.6, 0.1):
    ...
    seeds = [43, 47, 53, 59, 61, 67, 71, 73, 79, 83, 89, 97]
    for seed in seeds:
        print('Seed:', seed)
        over_x_train, over_x_test, over_y_train, over_y_test = train_test_split(encodedData, y.ravel(), test_size = 0.2, random_state = seed)
        ...
        if (seed == seeds[0]):
          seed_00_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_00_precision.append(precision_score(y_test, rfcPrediction))
          seed_00_sample_size.append(y_count.count(0))
        if (seed == seeds[1]):
          seed_01_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_01_precision.append(precision_score(y_test, rfcPrediction))
          seed_01_sample_size.append(y_count.count(0))
        if (seed == seeds[2]):
          seed_02_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_02_precision.append(precision_score(y_test, rfcPrediction))
          seed_02_sample_size.append(y_count.count(0))
        if (seed == seeds[3]):
          seed_03_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_03_precision.append(precision_score(y_test, rfcPrediction))
          seed_03_sample_size.append(y_count.count(0))
        if (seed == seeds[4]):
          seed_04_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_04_precision.append(precision_score(y_test, rfcPrediction))
          seed_04_sample_size.append(y_count.count(0))
        if (seed == seeds[5]):
          seed_05_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_05_precision.append(precision_score(y_test, rfcPrediction))
          seed_05_sample_size.append(y_count.count(0))
        if (seed == seeds[6]):
          seed_06_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_06_precision.append(precision_score(y_test, rfcPrediction))
          seed_06_sample_size.append(y_count.count(0))
        if (seed == seeds[7]):
          seed_07_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_07_precision.append(precision_score(y_test, rfcPrediction))
          seed_07_sample_size.append(y_count.count(0))
        if (seed == seeds[8]):
          seed_08_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_08_precision.append(precision_score(y_test, rfcPrediction))
          seed_08_sample_size.append(y_count.count(0))
        if (seed == seeds[9]):
          seed_09_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_09_precision.append(precision_score(y_test, rfcPrediction))
          seed_09_sample_size.append(y_count.count(0))
        if (seed == seeds[10]):
          seed_10_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_10_precision.append(precision_score(y_test, rfcPrediction))
          seed_10_sample_size.append(y_count.count(0))
        if (seed == seeds[11]):
          seed_11_accuracy.append(accuracy_score(y_test, rfcPrediction))
          seed_11_precision.append(precision_score(y_test, rfcPrediction))
          seed_11_sample_size.append(y_count.count(0))

statData = pd.DataFrame({'Minutes Elapsed': minutesElapsedThreshold})
statData.insert(1, ('Seed ' + str(seeds[0]) + ' Accuracy'), seed_00_accuracy)
statData.insert(2, ('Seed ' + str(seeds[0]) + ' Precision'), seed_00_precision)
statData.insert(3, ('Seed ' + str(seeds[0]) + ' Sample Size'), seed_00_sample_size)
statData.insert(4, ('Seed ' + str(seeds[1]) + ' Accuracy'), seed_01_accuracy)
statData.insert(5, ('Seed ' + str(seeds[1]) + ' Sample Size'), seed_01_sample_size)
statData.insert(6, ('Seed ' + str(seeds[1]) + ' Precision'), seed_01_precision)
statData.insert(7, ('Seed ' + str(seeds[2]) + ' Accuracy'), seed_02_accuracy)
statData.insert(8, ('Seed ' + str(seeds[2]) + ' Precision'), seed_02_precision)
statData.insert(9, ('Seed ' + str(seeds[2]) + ' Sample Size'), seed_02_sample_size)
statData.insert(10, ('Seed ' + str(seeds[3]) + ' Accuracy'), seed_03_accuracy)
statData.insert(11, ('Seed ' + str(seeds[3]) + ' Sample Size'), seed_03_sample_size)
statData.insert(12, ('Seed ' + str(seeds[3]) + ' Precision'), seed_03_precision)
statData.insert(13, ('Seed ' + str(seeds[4]) + ' Accuracy'), seed_04_accuracy)
statData.insert(14, ('Seed ' + str(seeds[4]) + ' Precision'), seed_04_precision)
statData.insert(15, ('Seed ' + str(seeds[4]) + ' Sample Size'), seed_04_sample_size)
statData.insert(16, ('Seed ' + str(seeds[5]) + ' Accuracy'), seed_05_accuracy)
statData.insert(17, ('Seed ' + str(seeds[5]) + ' Sample Size'), seed_05_sample_size)
statData.insert(18, ('Seed ' + str(seeds[5]) + ' Precision'), seed_05_precision)
statData.insert(19, ('Seed ' + str(seeds[6]) + ' Accuracy'), seed_06_accuracy)
statData.insert(20, ('Seed ' + str(seeds[6]) + ' Precision'), seed_06_precision)
statData.insert(21, ('Seed ' + str(seeds[6]) + ' Sample Size'), seed_06_sample_size)
statData.insert(22, ('Seed ' + str(seeds[7]) + ' Accuracy'), seed_07_accuracy)
statData.insert(23, ('Seed ' + str(seeds[7]) + ' Sample Size'), seed_07_sample_size)
statData.insert(24, ('Seed ' + str(seeds[7]) + ' Precision'), seed_07_precision)
statData.insert(25, ('Seed ' + str(seeds[8]) + ' Accuracy'), seed_08_accuracy)
statData.insert(26, ('Seed ' + str(seeds[8]) + ' Precision'), seed_08_precision)
statData.insert(27, ('Seed ' + str(seeds[8]) + ' Sample Size'), seed_08_sample_size)
statData.insert(28, ('Seed ' + str(seeds[9]) + ' Accuracy'), seed_09_accuracy)
statData.insert(29, ('Seed ' + str(seeds[9]) + ' Sample Size'), seed_09_sample_size)
statData.insert(30, ('Seed ' + str(seeds[9]) + ' Precision'), seed_09_precision)
statData.insert(31, ('Seed ' + str(seeds[10]) + ' Accuracy'), seed_10_accuracy)
statData.insert(32, ('Seed ' + str(seeds[10]) + ' Precision'), seed_10_precision)
statData.insert(33, ('Seed ' + str(seeds[10]) + ' Sample Size'), seed_10_sample_size)
statData.insert(34, ('Seed ' + str(seeds[11]) + ' Accuracy'), seed_11_accuracy)
statData.insert(35, ('Seed ' + str(seeds[11]) + ' Sample Size'), seed_11_sample_size)
statData.insert(36, ('Seed ' + str(seeds[11]) + ' Precision'), seed_11_precision)
statData.to_excel(f'{outputPath}/statData.xlsx', index = False)

statPlot = plt.figure()
plt.title('Minutes Elapsed vs Random Seed Accuracy')
plt.xlabel('Minutes Elapsed')
plt.ylabel('Accuracy Score')
plt.plot(minutesElapsedThreshold, seed_00_accuracy, linewidth = 1, label = seeds[0])
plt.plot(minutesElapsedThreshold, seed_01_accuracy, linewidth = 1, label = seeds[1])
plt.plot(minutesElapsedThreshold, seed_02_accuracy, linewidth = 1, label = seeds[2])
plt.plot(minutesElapsedThreshold, seed_03_accuracy, linewidth = 1, label = seeds[3])
plt.plot(minutesElapsedThreshold, seed_04_accuracy, linewidth = 1, label = seeds[4])
plt.plot(minutesElapsedThreshold, seed_05_accuracy, linewidth = 1, label = seeds[5])
plt.plot(minutesElapsedThreshold, seed_06_accuracy, linewidth = 1, label = seeds[6])
plt.plot(minutesElapsedThreshold, seed_07_accuracy, linewidth = 1, label = seeds[7])
plt.plot(minutesElapsedThreshold, seed_08_accuracy, linewidth = 1, label = seeds[8])
plt.plot(minutesElapsedThreshold, seed_09_accuracy, linewidth = 1, label = seeds[9])
plt.plot(minutesElapsedThreshold, seed_10_accuracy, linewidth = 1, label = seeds[10])
plt.plot(minutesElapsedThreshold, seed_11_accuracy, linewidth = 1, label = seeds[11])
